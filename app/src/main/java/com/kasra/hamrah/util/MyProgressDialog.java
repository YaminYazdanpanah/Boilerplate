...
public class MyProgressDialog {
    ...
    public MyProgressDialog(Context context) {
        ...
        progressBar.getIndeterminateDrawable().setColorFilter(context.getResources().getColor(R.color.color_white), android.graphics.PorterDuff.Mode.MULTIPLY);
